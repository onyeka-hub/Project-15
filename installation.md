...
Edit the path for sslcertificate in this file. Change the localhost.crt to ACS.crt and localhost.key to ACS.key
...
Create the target group for nginx, wordpress and tooling

Create your loadbalancers
